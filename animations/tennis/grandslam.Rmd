...
### Grand Slam Title over the years
...
animate(anim, nframes = 2160, fps = 50, height = 480, width = 600, res = 90, duration = 12)
```

### Grand Slam Performance (Main Draw)
...
animate(a, nframes = 2160, fps = 90, height = 500, width = 720, res = 100)
```
